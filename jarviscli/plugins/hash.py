...
def hash_data(jarvis, s: str) -> None:
    ...
    input_type = jarvis.input("Do you want to hash a string or a file? (Enter 'string' or 'file'): ").lower()

    # Ask user for hash function
    hash_function = jarvis.input("Enter the hash function (md5, sha1, sha256, etc.): ").lower()
